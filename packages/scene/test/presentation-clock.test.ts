...
describe("scene presentation clock", () => {
  ...
  it("clamps elapsed presentation time to the active duration", () => {
    expect(animationElapsedAt(3_000, 5_000, 14_000)).toBe(0);
    expect(animationElapsedAt(25_000, 5_000, 14_000)).toBe(14_000);
  });
});
