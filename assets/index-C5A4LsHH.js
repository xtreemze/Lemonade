...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xs(e,t,n){return new _o({name:`SphericalGaussianBlur`,defines:{SAMPLES:Fs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:$s(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zs(){return new _o({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:$s(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qs(){return new _o({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$s(),fragmentShader:`
	...
	`}var ec=class extends Br{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Za(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,$=(e,t,n)=>{let r=e.querySelector(t);if(!(r instanceof n))throw TypeError(`Expected ${t} to match ${n.name}.`);return r},pd=e=>Object.freeze({statusDay:$(e,`#status-day`,HTMLElement),statusCash:$(e,`#status-cash`,HTMLElement),statusDebtGroup:$(e,`#status-debt-group`,HTMLElement),statusDebt:$(e,`#status-debt`,HTMLElement),runStatus:$(e,`#run-status`,HTMLElement),runError:$(e,`#run-error`,HTMLElement),exportRun:$(e,`#export-run`,HTMLButtonElement),importRun:$(e,`#import-run`,HTMLButtonElement),importFile:$(e,`#import-file`,HTMLInputElement),resetRun:$(e,`#reset-run`,HTMLButtonElement),conditionWeather:$(e,`#condition-weather`,HTMLElement),conditionSentiment:$(e,`#condition-sentiment`,HTMLElement),conditionProduction:$(e,`#condition-production`,HTMLElement),conditionAdvertising:$(e,`#condition-advertising`,HTMLElement),financeTier:$(e,`#finance-tier`,HTMLElement),financeSummary:$(e,`#finance-summary`,HTMLElement),decisionPanel:$(e,`#decision-panel`,HTMLFormElement),decisionSpend:$(e,`#decision-spend`,HTMLElement),glasses:$(e,`#glasses`,HTMLInputElement),glassesOutput:$(e,`#glasses-output`,HTMLOutputElement),signs:$(e,`#signs`,HTMLInputElement),signsOutput:$(e,`#signs-output`,HTMLOutputElement),price:$(e,`#price`,HTMLInputElement),priceOutput:$(e,`#price-output`,HTMLOutputElement),decisionError:$(e,`#decision-error`,HTMLElement),sellButton:$(e,`#sell-button`,HTMLButtonElement),reportPanel:$(e,`#report-panel`,HTMLElement),reportEyebrow:$(e,`#report-eyebrow`,HTMLElement),reportTitle:$(e,`#report-title`,HTMLElement),reportNet:$(e,`#report-net`,HTMLElement),reportSales:$(e,`#report-sales`,HTMLElement),reportExpenses:$(e,`#report-expenses`,HTMLElement),reportCash:$(e,`#report-cash`,HTMLElement),reportDebt:$(e,`#report-debt`,HTMLElement),reportLedgerLines:$(e,`#report-ledger-lines`,HTMLTableSectionElement),reportEvent:$(e,`#report-event`,HTMLElement),reportProgression:$(e,`#report-progression`,HTMLElement),nextButton:$(e,`#next-button`,HTMLButtonElement),historyHost:$(e,`#ledger-history-host`,HTMLElement),sceneCanvas:$(e,`#scene-canvas`,HTMLCanvasElement),sceneFallback:$(e,`#scene-fallback`,HTMLElement),sceneFallbackDescription:$(e,`#scene-fallback-description`,HTMLElement),sceneEquivalent:$(e,`#scene-equivalent`,HTMLElement)}),md=(e,t)=>Number.isFinite(e.valueAsNumber)?e.valueAsNumber:t,hd=Object.freeze({persistenceEnabled:!0,initialPersistenceError:null}),gd=class{#e;#t;#n;#r=a();#i;#a;#o;#s;#c;#l;#u;#d;#f=Promise.resolve();#p=!1;constructor(e,t=dd(),n=hd){this.#t=t.seed,this.#n=gt(t),this.#o=t.state,this.#s=t.environment,this.#c=t.phase,this.#l=Number(t.draft.glasses),this.#u=Number(t.draft.signs),this.#d=Number(t.draft.price),this.#a=n.persistenceEnabled,e.innerHTML=fd,this.#e=pd(e),this.#i=ed({canvas:this.#e.sceneCanvas,fallback:this.#e.sceneFallback,fallbackDescription:this.#e.sceneFallbackDescription,equivalent:this.#e.sceneEquivalent}),this.#e.decisionPanel.addEventListener(`submit`,this.#y),this.#e.nextButton.addEventListener(`click`,this.#b),this.#e.glasses.addEventListener(`input`,this.#g),this.#e.signs.addEventListener(`input`,this.#_),this.#e.price.addEventListener(`input`,this.#v),this.#e.exportRun.addEventListener(`click`,this.#x),this.#e.importRun.addEventListener(`click`,this.#S),this.#e.importFile.addEventListener(`change`,this.#C),this.#e.resetRun.addEventListener(`click`,this.#w),document.addEventListener(`visibilitychange`,this.#m),window.addEventListener(`pagehide`,this.#h,{once:!0}),this.#e.importRun.disabled=!this.#a,this.#e.resetRun.disabled=!this.#a,this.#M(),n.initialPersistenceError===null?this.#a?this.#O(`Run saved locally.`):this.#e.runStatus.textContent=`Autosave is unavailable in this browser context.`:this.#A(n.initialPersistenceError)}dispose(){this.#p||(this.#p=!0,this.#e.decisionPanel.removeEventListener(`submit`,this.#y),this.#e.nextButton.removeEventListener(`click`,this.#b),this.#e.glasses.removeEventListener(`input`,this.#g),this.#e.signs.removeEventListener(`input`,this.#_),this.#e.price.removeEventListener(`input`,this.#v),this.#e.exportRun.removeEventListener(`click`,this.#x),this.#e.importRun.removeEventListener(`click`,this.#S),this.#e.importFile.removeEventListener(`change`,this.#C),this.#e.resetRun.removeEventListener(`click`,this.#w),document.removeEventListener(`visibilitychange`,this.#m),window.removeEventListener(`pagehide`,this.#h),this.#i.dispose(),this.#r.dispose())}#m=()=>{document.visibilityState===`hidden`?this.#r.suspend():this.#r.resume()};#h=()=>{this.dispose()};#g=()=>{this.#l=md(this.#e.glasses,this.#l),this.#P(),this.#I()};#_=()=>{this.#u=md(this.#e.signs,this.#u),this.#P(),this.#I()};#v=()=>{this.#d=md(this.#e.price,this.#d),this.#P()};#y=e=>{if(e.preventDefault(),this.#c.kind!==`deciding`||!this.#j().affordable)return;let t=ve(this.#o,Object.freeze({glasses:d(this.#l),signs:f(this.#u),price:l(this.#d)}),this.#s),n=this.#o.tier;this.#c=Object.freeze({kind:`report`,resolution:t}),this.#M(),this.#O(`Day report saved locally.`),this.#r.enable().then(e=>{if(!e)return;this.#r.play(`day:submit`);let r=Number(t.entry.net)>=0?`day:profit`:`day:loss`;window.setTimeout(()=>{this.#r.play(r)},220),t.nextState.tier!==n&&window.setTimeout(()=>{this.#r.play(`progression:unlock`)},520)})};#b=()=>{if(this.#c.kind!==`report`)return;let e=this.#c.resolution.nextState,t=j(e.day,this.#n),n=cd(e);this.#o=e,this.#s=t,this.#l=Math.min(this.#l,n.glasses),this.#u=Math.min(this.#u,n.signs),this.#c=Object.freeze({kind:`deciding`}),this.#M(),this.#O(`Next day saved locally.`),this.#r.enable().then(e=>{e&&this.#r.play(o(t.weather.kind))})};#x=()=>{try{let e=vt(this.#D()),t=new Blob([e],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`lemonade-run-day-${String(Number(this.#o.day))}.json`,r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n)},0),this.#k(`Portable run exported.`)}catch(e){this.#A(ud(e))}};#S=()=>{this.#a&&this.#e.importFile.click()};#C=()=>{let e=this.#e.importFile.files?.item(0);this.#e.importFile.value=``,e!=null&&this.#T(e)};#w=()=>{this.#a&&window.confirm(`Reset this run? The local run will be deleted. Export it first if you want a portable copy.`)&&this.#E()};async#T(e){try{let t=yt(await e.text());await this.#f,await Ct(t),window.location.reload()}catch(e){this.#A(ud(e))}}async#E(){try{await this.#f,await Tt(),window.location.reload()}catch(e){this.#A(ud(e))}}#D(){return Object.freeze({seed:this.#t,state:this.#o,environment:this.#s,draft:Object.freeze({glasses:d(this.#l),signs:f(this.#u),price:l(this.#d)}),phase:this.#c})}#O(e){if(!this.#a)return;let t=this.#D();this.#f=this.#f.then(async()=>{await Ct(t),this.#p||this.#k(e)}).catch(e=>{this.#p||this.#A(ud(e))})}#k(e){this.#e.runStatus.textContent=e,this.#e.runError.hidden=!0,this.#e.runError.textContent=``}#A(e){this.#e.runStatus.textContent=`Run storage needs attention.`,this.#e.runError.textContent=e,this.#e.runError.hidden=!1}#j(){let e=Number(re(this.#o)),t=Number(ne(this.#o)),n=this.#l*Number(this.#o.unitCost)+this.#u*Number(this.#o.signCost)+e;return Object.freeze({affordable:n<=t,operatingFunds:t,spend:n})}#M(){this.#N(),this.#P(),this.#F(),this.#I();let e=this.#c.kind===`report`?this.#c.resolution.nextState.ledger:this.#o.ledger;Ne(this.#e.historyHost,e)}#N(){this.#e.statusDay.textContent=String(Number(this.#o.day)),this.#e.statusCash.textContent=od(Number(this.#o.cash)),this.#e.statusDebt.textContent=od(Number(this.#o.loanBalance)),this.#e.statusDebtGroup.hidden=!(this.#o.tier>=3||Number(this.#o.loanBalance)>0),this.#e.conditionWeather.textContent=nd[this.#s.weather.kind],this.#e.conditionSentiment.textContent=rd[this.#s.sentiment.kind],this.#e.conditionProduction.textContent=`${od(Number(this.#o.unitCost))} / glass`,this.#e.conditionAdvertising.textContent=`${od(Number(this.#o.signCost))} / sign`,this.#e.financeTier.textContent=`Business tier ${String(this.#o.tier)}`,this.#e.financeSummary.textContent=ld(this.#o)}#P(){let e=cd(this.#o),t=this.#j();this.#e.decisionPanel.hidden=this.#c.kind!==`deciding`,this.#e.glasses.max=String(e.glasses),this.#e.glasses.value=String(this.#l),this.#e.glassesOutput.textContent=String(this.#l),this.#e.signs.max=String(e.signs),this.#e.signs.value=String(this.#u),this.#e.signsOutput.textContent=String(this.#u),this.#e.price.value=String(this.#d),this.#e.priceOutput.textContent=od(this.#d),this.#e.decisionSpend.textContent=`Spend ${od(t.spend)} of ${od(t.operatingFunds)} operating funds`,this.#e.decisionSpend.className=t.affordable?`spend`:`spend spend-warning`,this.#e.decisionError.hidden=t.affordable,this.#e.sellButton.disabled=!t.affordable}#F(){let e=this.#c.kind===`report`?this.#c.resolution:null;if(this.#e.reportPanel.hidden=e===null,e===null)return;let t=e.entry,n=Number(t.net);this.#e.reportEyebrow.textContent=`Day ${String(Number(t.day))} report`,this.#e.reportTitle.textContent=`${String(Number(t.sold))} of ${String(Number(t.decision.glasses))} sold`,this.#e.reportNet.className=n>=0?`profit`:`loss`,this.#e.reportNet.textContent=`${n>=0?`+`:`−`}${od(Math.abs(n))}`,this.#e.reportSales.textContent=od(Number(t.revenue)),this.#e.reportExpenses.textContent=od(Number(t.expenses)),this.#e.reportCash.textContent=od(Number(t.endingCash)),this.#e.reportDebt.textContent=od(Number(t.endingLoanBalance)),this.#e.reportEvent.textContent=id[t.environment.event.kind];let r=t.lines.map(e=>{let t=document.createElement(`tr`),n=document.createElement(`th`),r=document.createElement(`td`);return n.scope=`row`,n.textContent=e.label,r.className=e.direction===`credit`?`ledger-credit`:`ledger-debit`,r.textContent=`${e.direction===`credit`?`+`:`−`}${od(Number(e.amount))}`,t.append(n,r),t});this.#e.reportLedgerLines.replaceChildren(...r);let i=e.nextState.tier!==this.#o.tier;this.#e.reportProgression.hidden=!i,this.#e.reportProgression.textContent=i?`Tier ${String(e.nextState.tier)} unlocks tomorrow. New finance rules will be shown before you sell.`:``}#I(){let e=this.#c;this.#i.update({environment:this.#s,visibleSigns:e.kind===`report`?Number(e.resolution.entry.decision.signs):this.#u,phase:e.kind,sold:e.kind===`report`?Number(e.resolution.entry.sold):0,prepared:e.kind===`report`?Number(e.resolution.entry.decision.glasses):this.#l})}},_d=document.querySelector(`#root`);if(!(_d instanceof HTMLElement))throw TypeError(`Expected #root application mount point.`);var vd=e=>{_d.innerHTML=`
  ...
  `;let t=_d.querySelector(`#recovery-error`),n=_d.querySelector(`#discard-saved-run`);if(!(t instanceof HTMLElement)||!(n instanceof HTMLButtonElement))throw TypeError(`Expected saved-run recovery controls.`);t.textContent=e.message,n.addEventListener(`click`,()=>{n.disabled=!0,Tt().then(()=>{window.location.reload()}).catch(e=>{n.disabled=!1,t.textContent=e instanceof Error?e.message:`Unable to clear browser run storage.`})},{once:!0})};(async()=>{try{new gd(_d,await wt()??dd())}catch(e){if(e instanceof We&&(e.code===`storage-unavailable`||e.code===`storage-failed`)){new gd(_d,dd(),{persistenceEnabled:!1,initialPersistenceError:e.message});return}if(e instanceof We){vd(e);return}throw e}})();