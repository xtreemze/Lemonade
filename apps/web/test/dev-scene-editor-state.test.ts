...
describe("3d scene editor state", () => {
  it("round-trips scene, camera, density, and semantic transform state", () => {
    const transform = Object.freeze({
      ...
      rotation: Object.freeze([0.1, 0.2, 0.3]) as readonly [number, number, number],
      scale: Object.freeze([1.1, 1.2, 1.3]) as readonly [number, number, number],
    });
  ...
  it("replaces and removes persisted transforms by semantic key", () => {
    ...
    const second = Object.freeze({
      ...first,
      position: Object.freeze([2, 0, 0]) as readonly [number, number, number],
    });
