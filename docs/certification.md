...
6. Visual showcase evidence
   ...
   - forecast and simulation probe Chromium’s native source cadence, select the highest certified candidate the browser actually produces (60 fps minimum), and capture deterministic WebGL source frames at that rate with real procedural Web Audio in parallel; planning/report/history use full-viewport PNG screenshots;
