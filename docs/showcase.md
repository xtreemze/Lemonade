...
Representative CI-authored imagery is embedded here so the visual design documentation stays tied to the application that actually shipped.

### Desktop

<img src="https://xtreemze.github.io/Lemonade/showcase/desktop/03-lemonsville-simulation.gif" alt="Desktop Lemonsville neighborhood simulation around the lemonade stand" width="760" />

### Mobile

<img src="https://xtreemze.github.io/Lemonade/showcase/mobile/03-lemonsville-simulation.gif" alt="Portrait mobile Lemonsville neighborhood simulation around the lemonade stand" width="320" />

The README presents all five desktop and all five mobile scenes. The media is regenerated by CI rather than checked into source control.
